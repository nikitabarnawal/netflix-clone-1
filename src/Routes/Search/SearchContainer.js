...
class SearchContainer extends React.Component {
  ...
  // 주의!!! 만약 리액트에서 컴포넌트 안에서만 쓰일 componentDidMount같은 함수면 componentDidMount(){}형태로 만들어줘도 상관없지만 handleSubmit이나 updateSearchTerm같이 SearchPresenter.js같은 곳에서 onChange등의 이벤트에 맞춰서 실행될 함수라면
