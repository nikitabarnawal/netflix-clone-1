...
import Helmet from "react-helmet"; // react-helmet모듈을 이용하면 웹 사이트의 head태그안의 내용을 수정할 수 있도록 도와준다.
...
const HomePresenter = ({ nowPlaying, upcoming, popular, topRated, error, loading, nowPlaying2 }) => {
  return loading ? (
    ...
    <Container>
      ...
      {/* <Helmet><title>넷플릭스 - 영화</title></Helmet>처럼 Helmet컴포넌트 안에 태그를 넣어주면 head태그 안에 들어가게 된다. */}
      <Helmet>
        <title>넷플릭스 - 영화</title>
      </Helmet>
